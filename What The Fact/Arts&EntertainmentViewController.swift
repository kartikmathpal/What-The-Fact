//
//  Arts&EntertainmentViewController.swift
//  What The Fact
//
...
class Arts_EntertainmentViewController: UIViewController {
    
    @IBOutlet weak var funFactTextView: UITextView!
    @IBOutlet weak var funFactButton: UIButton!
    
    let factBook = ArtEntertainmentFactBook() //initialize a struct variable,an instance is created
